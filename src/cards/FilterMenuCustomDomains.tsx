...
import { ActiveFilters } from '../pagesSuperAdmin/CustomDomains/ListCustomDomains';

const FilterMenuCustomDomains = forwardRef<HTMLDivElement, {
    ...
    >
      <div className="p-4">
        <div className="flex justify-between items-center mb-4 sticky top-0 bg-white dark:bg-gray-800 py-2 z-10">
          <h3 className="text-lg font-medium text-gray-800 dark:text-white">Filter Domains</h3>
          <button
            onClick={onClose}
...
export default FilterMenuCustomDomains;